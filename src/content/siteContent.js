...
export const clientLogos = [
  ...
  { name: 'Instituto Wani Higino', image: '/brand/clients/instituto-wani-higino.png', logoClass: 'max-h-14 max-w-[88%]' },
  ...
  { name: 'Prefeitura de Santo Antônio do Amparo', image: '/brand/clients/prefeitura-saa.png', logoClass: 'max-h-16 max-w-[82%]' },
  { name: 'Câmara Municipal de Betim', image: '/brand/clients/camara-betim.png', logoClass: 'max-h-20 max-w-[88%]' },
  { name: 'Salão do Encontro', image: '/brand/clients/salao-do-encontro.png', logoClass: 'max-h-16 max-w-[82%]' },
  ...
  { name: 'Tropicália Kombucha', image: '/brand/clients/tropicalia-kombucha.png', logoClass: 'max-h-14 max-w-[82%]' },
