  ...
  return (
    <div className="min-h-screen bg-[#f7f4e8] text-grafite">
      ...
      <section className="section-padding mx-auto grid max-w-7xl gap-10 py-16 lg:grid-cols-[1.05fr,0.95fr] lg:items-center lg:py-24">
        <div>
          ...
          <h1 className="mt-6 max-w-3xl font-display text-5xl font-bold leading-[0.95] md:text-7xl">
            Sua instituição usa fotos ou vídeos de crianças?
          </h1>
          <div className="mt-7 max-w-2xl space-y-5 text-lg leading-relaxed text-grafite/70">
            <p>
              Baixe o guia preparado pela Plante e entenda o que deve ser observado antes de fotografar, publicar ou impulsionar conteúdos com crianças e adolescentes.
            </p>
            <p>
              O material reúne orientações práticas para escolas, clínicas, projetos sociais, empresas, instituições públicas e organizações que trabalham com esse público.
            </p>
          </div>
      ...
      <section className="bg-white py-20 text-grafite">
        <div className="section-padding mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.95fr,1.05fr] lg:items-start">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-grafite/65">
              Preencha seus dados para acessar o material e compartilhar com as pessoas que fotografam, recebem, aprovam ou publicam conteúdos na sua instituição.
            </p>
          </div>
          <LeadCaptureForm compact formId="formulario-guia-secundario" />
        </div>
      </section>
